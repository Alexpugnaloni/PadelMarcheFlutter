...
class ViewProfile extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    /*      Container(
            padding: EdgeInsets.only(top:30.0,left: 40.0,right: 40.0, bottom: 20),
            child:Text("Statistiche", style: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold),textAlign:TextAlign.center,),
          ),
          visualizzaCampo("Post effettuati", args.account['nPost'].toString(),context),
          SizedBox(height: 20),
          visualizzaCampo("Commenti effettuati", args.account['nCommenti'].toString(),context),
          SizedBox(height: 20),
          visualizzaCampo("Data Ultimo post", args.account['dataUltimoPost']==""?"Non hai ancora pubblicato nulla":args.account['dataUltimoPost'],context),
          SizedBox(height: 20),
          visualizzaCampo("Data Ultimo commento", args.account['dataUltimoCommento']==""?"Non hai ancora pubblicato nulla":args.account['dataUltimoCommento'],context),
          SizedBox(height: 20) */
        ],
      ),
    );
